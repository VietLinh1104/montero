            ...
            <div class="container-lg">
                ...
                <div class="container-fluid me-4 border rounded p-1">
                    <div class="bg-white border-bottom m-0 pb-1">
                        ...
                        <p class="text-gray-light fs-14 m-0">Sửa Sản Phẩm</p>
                    </div>
                    ...
                    <div class="container-fruid pt-1">
                        <div class="row">
                            ...
                            <div class="col pe-2">
                                ...
                                <p class="text-gray-light fs-14">Form sửa sản phẩm.</p>
                            </div>
                            <div class="col-10 pb-0">
                                
                                <!-- form -->
                                <form action="<?php echo CONTROLLERS_PATH .'editItem.php?id='.$id ?>" method="post" enctype="multipart/form-data">
                                    <div class="row ">
                                        <div class="col">
                                    ...
                                    <div class="container bg-white border-top m-0 pt-1">
                                        <div class="row">
                                            <div class="col d-flex justify-content-end">
                                              ...
                                              <div>
                                                  <button class="btn btn-gray" type="submit">Sửa Sản Phẩm</button>
